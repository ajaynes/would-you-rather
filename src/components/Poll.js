              ...
              <Col span={16}>
                {!answer ? (
                  ...
                  <>
                    ...
                    <div
                      className={
                        answer.text === question.optionOne.text
                          ? "selected"
                          : "not-selected"
                      }
                    >
                      ...
                      <p>
                        ...
                        {optionOneVotes + optionTwoVotes} votes
                      </p>
                      <Progress
                        strokeWidth={50}
                        strokeLinecap="square"
                        percent={(optionOneVotes * percentage).toFixed(0)}
                        format={percent => `${percent}%`}
                      />
                    </div>
                    <div
                      className={
                        answer.text === question.optionTwo.text
                          ? "selected"
                          : "not-selected"
                      }
                    >
                      ...
                      <Progress
                        strokeWidth={50}
                        strokeLinecap="square"
                        percent={(optionTwoVotes * percentage).toFixed(0)}
                        format={percent => `${percent}%`}
                      />
                    </div>
                    <Button type="primary">
